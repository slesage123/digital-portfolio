...
const images = [
    ...
    { pic: "/digital-portfolio/businesscards.jpg", text: "Logo and branding concepts for a high end law firm." },
    { pic: "/digital-portfolio/letterheadpen.jpg", text: "Logo and branding concepts for a high end law firm." },
    { pic: "/digital-portfolio/webplaced.jpg", text: "Web page concept for a high end law firm." },
    { pic: "/digital-portfolio/webconcept.jpg", text: "Web page concept for a high end law firm." },
